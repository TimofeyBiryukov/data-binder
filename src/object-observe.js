/*
 ...
 TODO:
 Add support for Object.prototype.watch ->
...
if (!Object.observe) {
	(function (extend, global) {
		...
		var Observer = (function Observer(){
			var wraped = [];
			var ObserverTmp = function (O, callback, accept){
			...
			ObserverTmp.prototype.deliverChangeRecords = function (O){
		...
		var Notifier = function Notifier(watching){
			...
			self._checkPropertyListing = function _checkPropertyListing(dontQueueUpdates){
				...
				//var newKeys = [];
				var oldKeys = properties.slice(0);
				//var updates = [];
